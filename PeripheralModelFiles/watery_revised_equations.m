...
%      d(X(1))/dt = 1/compartment*(ReactionFlux6 - ReactionFlux7 - ReactionFlux57 - ReactionFlux58 + ReactionFlux59);
     ...
     X = sym('X', [1 27]);
     f = sym('f', [62 1]);
%      f(1) = Time_Sim_production_rate_k; f(2) = MAb_PCSK9_association_rate_k;
%      f(3) = MAb_PCSK9_kel; f(4) = MAb_PCSK9_association_rate_k*MAb_PCSK9_Kd;
%      f(5) = MAb_kel; f(6) = Statin_Ka*Statin_F;
%      f(7) = Statin_kel; f(8) = LDLR_ic_P_production_rate_k;
%      f(9) = LDLR_ic_to_cs_P_trafficking_rate_k;
%      f(10) = SREBP_ic_P_production_rate_k;
%      f(11) = SREBP_ic_P_degradation_rate_k; f(12) = SREBP_ic_to_nu_P_activation_rate_k;
