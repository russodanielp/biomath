...
project = sbioloadproject('Hepatic_Cholesterol_Model.sbproj');
model = project.m1; 
...
figure
[t9,x9,n9] = selectbyname(simDataObj, 'SREBP_nu_H');hold on
plot(t9/24,x9,plotstyle{1}), hold on
xlabel('Time [days]')
ylabel('Hepatic SREBP')


save ('Simbio_HepaticCholModel.mat')